...
typedef void FxBehaviorNode_internal_dealloc_FUNC(uint64_t heap, void* obj, uint64_t size);
static FxBehaviorNode_internal_dealloc_FUNC* FxBehaviorNode_internal_dealloc = (FxBehaviorNode_internal_dealloc_FUNC*)0x140cc2250;
