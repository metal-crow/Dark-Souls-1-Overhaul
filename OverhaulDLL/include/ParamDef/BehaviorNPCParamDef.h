...
class BehaviorNpcParamDef : public BaseParamDef {
...
public:
	...
	{
		return (BehaviorNpcParam*)BaseParamDef::data();
	}

	BehaviorNpcParam *get(int index)
	{
		return (BehaviorNpcParam*)BaseParamDef::get(index);
	}
...
private:
	BehaviorNpcParamDef()
		: BaseParamDef(NULL, 0x7070, 2400, sizeof(BehaviorNpcParam), "D0 70 00 00 B9 9C 01 00 07 00 00 00 F0 70", "BehaviorNpcParam", "BehaviorNpc")
	{
	}
