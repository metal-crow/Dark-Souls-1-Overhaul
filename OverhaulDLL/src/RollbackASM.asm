...
EXTERN hkpWorld_addEntity_return: qword
extern OnEntityAdded: proc

PUBLIC hkpWorld_addEntity_injection
hkpWorld_addEntity_injection PROC
FUNC_PROLOGUE_LITE
call    OnEntityAdded
FUNC_EPILOGUE_LITE
...
push    rdi
sub     rsp, 50h
jmp     hkpWorld_addEntity_return
hkpWorld_addEntity_injection ENDP


EXTERN hkpWorld_removeEntities_return: qword
extern OnEntitiesRemoved: proc

PUBLIC hkpWorld_removeEntities_injection
hkpWorld_removeEntities_injection PROC
FUNC_PROLOGUE_LITE
call    OnEntitiesRemoved
FUNC_EPILOGUE_LITE
test    r8d, r8d
jle     removeEntities_skip
push    rbp
push    rbx
push    rsi
push    rdi
mov     rbp, rsp
jmp     hkpWorld_removeEntities_return
removeEntities_skip:
ret
hkpWorld_removeEntities_injection ENDP


EXTERN hkpWorld_addPhantom_return: qword
extern OnPhantomAdded: proc

PUBLIC hkpWorld_addPhantom_injection
hkpWorld_addPhantom_injection PROC
FUNC_PROLOGUE_LITE
call    OnPhantomAdded
FUNC_EPILOGUE_LITE
...
mov     rbx, rcx
mov     rdi, rdx
jmp     hkpWorld_addPhantom_return
hkpWorld_addPhantom_injection ENDP


EXTERN hkpWorld_removePhantom_return: qword
extern OnPhantomRemoved: proc

PUBLIC hkpWorld_removePhantom_injection
hkpWorld_removePhantom_injection PROC
FUNC_PROLOGUE_LITE
call    OnPhantomRemoved
FUNC_EPILOGUE_LITE
mov     qword ptr [rsp+8], rbx
push    rdi
sub     rsp, 30h
mov     rbx, rcx
mov     rdi, rdx
jmp     hkpWorld_removePhantom_return
