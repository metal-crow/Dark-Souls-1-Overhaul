...
#ifndef _DS1_FILE_LIB_SPECIAL_EFFECT_VFX_PARAM_DEF_FILE_H_
    #define _DS1_FILE_LIB_SPECIAL_EFFECT_VFX_PARAM_DEF_FILE_H_
...
#endif // _DS1_FILE_LIB_SPECIAL_EFFECT_VFX_PARAM_DEF_FILE_H_
