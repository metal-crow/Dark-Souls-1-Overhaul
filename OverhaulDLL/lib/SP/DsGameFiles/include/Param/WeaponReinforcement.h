...
#ifndef _DS1_OVERHAUL_WEAPON_REINFORCEMENT_PARAM_DEF_FILE_H_
    #define _DS1_OVERHAUL_WEAPON_REINFORCEMENT_PARAM_DEF_FILE_H_
...
#endif // _DS1_OVERHAUL_WEAPON_REINFORCEMENT_PARAM_DEF_FILE_H_
